...
This repository contains PyTorch code for the paper [ReClor: A Reading Comprehension Dataset Requiring Logical Reasoning (ICLR 2020)](https://openreview.net/pdf?id=HJgJtT4tvB). For the data and information, please check out the [project page](http://whyu.me/reclor). 
